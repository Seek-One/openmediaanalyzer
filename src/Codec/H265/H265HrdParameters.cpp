	...
	for(int i = 0;i < fixed_pic_rate_general_flag.size();++i){
		if(fixed_pic_rate_within_cvs_flag[i]) {
			if(elemental_duration_in_tc_minus1[i] > 2047) {
				errors.push_back((std::ostringstream() << "[HRD parameters] elemental_duration_in_tc_minus1[" << i <<"] value (" << (int)elemental_duration_in_tc_minus1[i] <<") not in valid range (0..2047)").str());
			}
		}
		if(cpb_cnt_minus1[i] > 31) errors.push_back((std::ostringstream() << "[HRD parameters] cpb_cnt_minus1[" << i << "] value (" << cpb_cnt_minus1[i] << ") not in valid range (0..31)").str());
		if(nal_hrd_parameters_present_flag){
			for(int j = 0;j <= cpb_cnt_minus1[i];++j){
				if(nal_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] == UINT32_MAX){
					errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].bit_rate_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] << ") not in valid range (0..4294967294)").str());
				}
				if(nal_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] == UINT32_MAX){
					errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].cpb_size_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] << ") not in valid range (0..4294967294)").str());
				}
				if(j > 0){
					if(nal_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] <= nal_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j-1]){
						errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].bit_rate_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] << ") less or equal to previous bit rate value").str());
					}
					if(nal_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] <= nal_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j-1]){
						errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].cpb_size_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] << ") less or equal to previous cpb size value").str());
					}
				}
				if(sub_pic_hrd_params_present_flag){
					if(nal_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] == UINT32_MAX){
						errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].cpb_size_du_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] << ") not in valid range (0..4294967294)").str());
					}
					if(nal_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] == UINT32_MAX){
						errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].bit_rate_du_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] << ") not in valid range (0..4294967294)").str());
					}
					if(j > 0){
						if(nal_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] <= nal_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j-1]){
							errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].cpb_size_du_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] << ") less or equal to previous cpb value du value").str());
						}
						if(nal_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] <= nal_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j-1]){
							errors.push_back((std::ostringstream() << "[HRD parameters] nal_sub_layer_hrd_parameters[" << i << "].bit_rate_du_value_minus1[" << j << "] value (" << nal_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] << ") less or equal to previous bit rate du value").str());
						}
					}
				}
			}
		...
		if(vcl_hrd_parameters_present_flag){
			...
			for(int j = 0;j <= cpb_cnt_minus1[i];++j){
				if(vcl_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] == UINT32_MAX){
					errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].bit_rate_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] << ") not in valid range (0..4294967294)").str());
				}
				if(vcl_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] == UINT32_MAX){
					errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].cpb_size_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] << ") not in valid range (0..4294967294)").str());
				}
				if(j > 0){
					if(vcl_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] <= vcl_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j-1]){
						errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].bit_rate_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].bit_rate_value_minus1[j] << ") less or equal to previous bit rate value").str());
					}
					if(vcl_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] <= vcl_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j-1]){
						errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].cpb_size_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].cpb_size_value_minus1[j] << ") less or equal to previous cpb size value").str());
					}
				}
				if(sub_pic_hrd_params_present_flag){
					if(vcl_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] == UINT32_MAX){
						errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].cpb_size_du_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] << ") not in valid range (0..4294967294)").str());
					}
					if(vcl_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] == UINT32_MAX){
						errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].bit_rate_du_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] << ") not in valid range (0..4294967294)").str());
					}
					if(j > 0){
						if(vcl_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] <= vcl_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j-1]){
							errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].cpb_size_du_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].cpb_size_du_value_minus1[j] << ") less or equal to previous cpb value du value").str());
						}
						if(vcl_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] <= vcl_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j-1]){
							errors.push_back((std::ostringstream() << "[HRD parameters] vcl_sub_layer_hrd_parameters[" << i << "].bit_rate_du_value_minus1[" << j << "] value (" << vcl_sub_layer_hrd_parameters[i].bit_rate_du_value_minus1[j] << ") less or equal to previous bit rate du value").str());
						}
					}
				}
			}
