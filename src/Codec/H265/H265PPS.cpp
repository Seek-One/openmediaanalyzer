...
H265PPS::H265PPS():
	H265PPS(0, H265NALUnitType::Unspecified, 0, 0, 0, nullptr)
{}

H265PPS::H265PPS(uint8_t forbidden_zero_bit, H265NALUnitType::Type nal_unit_type, uint8_t nuh_layer_id, uint8_t nuh_temporal_id_plus1, uint32_t nal_size, const uint8_t* nal_data):
