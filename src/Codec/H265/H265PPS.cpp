...
void H265PPS::validate(){
	...
	if(num_tile_columns_minus1 > pSps->PicWidthInCtbsY-1) errors.push_back((std::ostringstream() << "[H265 PPS] num_tile_columns_minus1 value (" << num_tile_columns_minus1 << ") not in valid range (0.." << pSps->PicWidthInCtbsY-1 << ")").str());
	if(num_tile_rows_minus1 > pSps->PicHeightInCtbsY-1) errors.push_back((std::ostringstream() << "[H265 PPS] num_tile_rows_minus1 value (" << num_tile_rows_minus1 << ") not in valid range (0.." << pSps->PicHeightInCtbsY-1 << ")").str());
	if(tiles_enabled_flag && num_tile_columns_minus1 == 0 && num_tile_rows_minus1 == 0) errors.push_back("[H265 PPS] num_tile_columns_minus1 and num_tile_rows_minus1 both equal to 0 with set tiles_enabled_flag");
