...
#ifndef TOOLKIT_CODEC_UTILS_H26X_H26XNALHEADER_H
#define TOOLKIT_CODEC_UTILS_H26X_H26XNALHEADER_H

#include "../H26X/H26XDumpObject.h"
#include "../H26X/H26XErrors.h"

struct H26XNALHeader
{
	virtual void dump(H26XDumpObject& dumpObject) const;
	virtual void checkErrors(H26XErrors& errors) const;
};

#endif //TOOLKIT_CODEC_UTILS_H26X_H26XNALHEADER_H
