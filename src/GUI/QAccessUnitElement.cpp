...
void QAccessUnitElement::updateBarColor(){
    switch(m_pAccessUnitModel->m_status){
        case QAccessUnitModel::OK:
            break;
        case QAccessUnitModel::REFERENCED_IFRAME_MISSING:
        case QAccessUnitModel::REFERENCED_PPS_OR_SPS_MISSING:
        case QAccessUnitModel::OUT_OF_ORDER:
        case QAccessUnitModel::MISSING_IFRAME:
            m_barColor = QColor::fromRgb(255, 20, 20, m_interactable ? 255 : 128);
            break;
    }
}
